...
public class Start {
    ...
    public void playGame() {
        ...
        System.out.println("Welcome to the Random Guessing Number Game!");
        System.out.print("Enter your name: ");
        String playerName = scanner.nextLine();
        user.setName(playerName);
        System.out.println("Hello, " + user.getName() + "! Guess the number between 1 and 100.");
        ...
        do {
            ...
            if (result.equals("yeahhhhhh!You guessed the correct number.")) {
                System.out.println("You guessed it in " + user.getAttempts() + " attempts.");
                break;
            }

            System.out.print("Do you want to continue? (yes,i'm bored/no,wanna try againnn): ");
